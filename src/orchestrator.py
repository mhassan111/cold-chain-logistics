...
AGENT_LLM_SETTING = os.getenv("AGENT_LLM", "GEMINI").strip().upper()
...
if AGENT_LLM_SETTING == "OPENAI":
    ...
    print("🤖 Brain Mode: Utilizing Cloud Gemini Reasoner (gemini-2.5-flash)...")
    ...
    print("🤗 Brain Mode: Local Fallback Activated. Binding Local Ollama (llama3.2)...")
    from langchain_ollama import ChatOllama

    llm = ChatOllama(model="llama3.2", temperature=0, num_predict=1024, base_url="http://localhost:11434")
